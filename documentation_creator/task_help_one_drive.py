...
if __name__ == '__main__': 
    ...
    user_message  = """
        rewite the sample teams documentation to write about One drive activity and one drive usage report api (reportRoot: getOneDriveUsageAccountDetail and reportRoot: getOneDriveActivityUserDetail). using this information
...
getOneDriveActivityUserDetail	https://graph.microsoft.com/v1.0/reports/getOneDriveActivityUserDetail(date={date_value}
Reports.Read.All

getOneDriveUsageAccountDetail	https://graph.microsoft.com/v1.0/reports/getOneDriveUsageAccountDetail(period='D7'
...
- Index: azgraph.onedrive.usage.details
Tracks information  .....
